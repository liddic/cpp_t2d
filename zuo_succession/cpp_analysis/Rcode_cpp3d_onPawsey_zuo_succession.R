...
# - collate_compounds
#
# For study - Zuo et al plantation succession soils
...
message("\nworkdir <- '/scratch/pawsey1216/cliddicoat/zuo_succession/cpp_analysis'")
workdir <- "/scratch/pawsey1216/cliddicoat/zuo_succession/cpp_analysis"
message("\nsetwd(workdir)")
setwd(workdir)
message("\ntemp_dir <- '/scratch/pawsey1216/cliddicoat/zuo_succession/cpp_analysis/working'")
temp_dir <- "/scratch/pawsey1216/cliddicoat/zuo_succession/cpp_analysis/working"

message("\nthis_study <- '-zuo-succession-pawsey'")
this_study <- "-zuo-succession-pawsey"
message("\nphy <- readRDS('phy-phyloseq-fxn-zuo_succession-v8c.RDS')")
phy <- readRDS("phy-phyloseq-fxn-zuo_succession-v8c.RDS")
