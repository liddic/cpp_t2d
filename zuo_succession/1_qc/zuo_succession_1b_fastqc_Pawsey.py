# # # # # # # # # # # # # # # #
# # FastQC (without MultiQC) - for Zuo et al forest succession metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/zuo_succession/1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/zuo_succession/1_qc'
