# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Zuo et al plantation succession metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/zuo_succession/2_clean_fastp'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/zuo_succession/3_fxn_superfocus'
...
table = pd.read_csv('/scratch/pawsey1216/cliddicoat/zuo_succession/1_meta_raw/zuo_succession_combined_reads.tsv.txt', sep='\t')
