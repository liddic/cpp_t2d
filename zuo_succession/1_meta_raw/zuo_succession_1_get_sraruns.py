# # # # # # # # # # # # # # # #
# # Download SRA fastq files - Zuo et al plantation succession metagenomics
# # # # # # # # # # # # # # # #
...
file_path = '/scratch/pawsey1216/cliddicoat/zuo_succession/1_meta_raw/all_SRR_Acc_List_zuo_succession.txt'
