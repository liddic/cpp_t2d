# # # # # # # # # # # # # # # #
# # Fastp - QC trimming for Liu_2020_mice_soil_PRJNA542998 metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/Liu_2020_mice_soil_PRJNA542998/1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/Liu_2020_mice_soil_PRJNA542998/2_clean_fastp'
...
for i in range(n):
    ...
    fh.writelines("fastp --length_required 60 --average_qual 25 --n_base_limit 1 --dedup \\\n")
    fh.writelines("    --trim_front1 15 --trim_tail1 10 --trim_front2 15 --trim_tail2 10 \\\n")
    fh.writelines("    --cut_mean_quality 30 --cut_window_size 10 --cut_front --cut_tail \\\n")
