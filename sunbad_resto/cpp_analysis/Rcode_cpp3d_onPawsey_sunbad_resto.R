...
# - collate_compounds
#
# For study - Sun & Badgley - post-mining restoration soils
...
message("\nworkdir <- '/scratch/pawsey1216/cliddicoat/sunbad_resto/cpp_analysis'")
workdir <- "/scratch/pawsey1216/cliddicoat/sunbad_resto/cpp_analysis"
message("\nsetwd(workdir)")
setwd(workdir)
message("\ntemp_dir <- '/scratch/pawsey1216/cliddicoat/sunbad_resto/cpp_analysis/working'")
temp_dir <- "/scratch/pawsey1216/cliddicoat/sunbad_resto/cpp_analysis/working"

message("\nthis_study <- '-sunbad-resto-pawsey'")
this_study <- "-sunbad-resto-pawsey"
