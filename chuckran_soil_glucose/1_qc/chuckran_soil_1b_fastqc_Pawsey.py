# # # # # # # # # # # # # # # #
# # FastQC (without MultiQC) - for Chuckran et al soil glucose metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/chuckran_soil_glucose/1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/chuckran_soil_glucose/1_qc'
