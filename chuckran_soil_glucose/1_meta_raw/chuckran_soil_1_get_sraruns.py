# # # # # # # # # # # # # # # #
# # Download SRA fastq files - chuckran_soil glucose addition metagenomics
# # # # # # # # # # # # # # # #
...
file_path = '/scratch/pawsey1216/cliddicoat/chuckran_soil_glucose/1_meta_raw/chuckran-soil-glucose-runlist.txt'
...
for i in range(n):
    ...
    fh.writelines("#SBATCH --partition=copy\n")
