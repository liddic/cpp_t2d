...
# - collate_compounds
#
# For study - Wang et al vegetation succession soils
...
message("\nworkdir <- '/scratch/pawsey1216/cliddicoat/wang_veg_succession/cpp_analysis'")
workdir <- "/scratch/pawsey1216/cliddicoat/wang_veg_succession/cpp_analysis"
message("\nsetwd(workdir)")
setwd(workdir)
message("\ntemp_dir <- '/scratch/pawsey1216/cliddicoat/wang_veg_succession/cpp_analysis/working'")
temp_dir <- "/scratch/pawsey1216/cliddicoat/wang_veg_succession/cpp_analysis/working"

message("\nthis_study <- '-wang-veg-succession-pawsey'")
this_study <- "-wang-veg-succession-pawsey"
message("\nphy <- readRDS('phy-phyloseq-fxn-wang-veg-succession-v8c.RDS')")
phy <- readRDS("phy-phyloseq-fxn-wang-veg-succession-v8c.RDS")
