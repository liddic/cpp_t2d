# # # # # # # # # # # # # # # #
# # Download SRA fastq files - Wang et al veg succession metagenomics
# # # # # # # # # # # # # # # #
...
file_path = '/scratch/pawsey1216/cliddicoat/wang_veg_succession/1_meta_raw/SRR_Acc_List_wang_veg_succession.txt'
