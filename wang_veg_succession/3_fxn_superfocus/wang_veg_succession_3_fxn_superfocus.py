# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Wang et al veg succession metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/wang_veg_succession/2_clean_fastp'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/wang_veg_succession/3_fxn_superfocus'
...
table = pd.read_csv('/scratch/pawsey1216/cliddicoat/wang_veg_succession/1_meta_raw/wang_veg_succession_combined_reads.tsv.txt', sep='\t')
