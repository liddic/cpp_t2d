# # # # # # # # # # # # # # # #
# # Fastp - QC for Wang et al veg succession metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/wang_veg_succession/1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/wang_veg_succession/2_clean_fastp'
...
for i in range(n):
    ...
    # reverse reads are poor quality - so see how this goes ??
