# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Forslund T2D Chinese metagenomics - Rarefied sequences Minimum library size
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/ft2d_chn/2c_rarefy_even_seq_min'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/ft2d_chn/3_fxn_superfocus_min'
...
file_path = '/scratch/pawsey1216/cliddicoat/ft2d_chn/2c_rarefy_even_seq_min/keep_t2d_chn_list_min.txt'
