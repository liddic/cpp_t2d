# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Forslund T2D Chinese metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/ft2d_chn/2b_clean_hostremoval'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/ft2d_chn/3_fxn_superfocus'
