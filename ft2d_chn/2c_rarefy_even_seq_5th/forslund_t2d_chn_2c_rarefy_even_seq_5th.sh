...
cd /scratch/pawsey1216/cliddicoat/ft2d_chn/2c_rarefy_even_seq_5th
...
seqtk sample -s100 /scratch/pawsey1216/cliddicoat/ft2d_chn/2b_clean_hostremoval/"$f"_non_host.1.fastq 5962972 > /scratch/pawsey1216/cliddicoat/ft2d_chn/2c_rarefy_even_seq_5th/"$f"_non_host_rarefy_even.1.fastq
