# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Forslund T2D Swedish metagenomics - Rarefied sequences Minimum library size
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/ft2d_swe/2c_rarefy_even_seq_min'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/ft2d_swe/3_fxn_superfocus_min'
...
file_path = '/scratch/pawsey1216/cliddicoat/ft2d_swe/2c_rarefy_even_seq_min/keep_t2d_swe_list_min.txt'
samples = import_strings_from_file(file_path)
...
for i in range(n):
    ...
    qc_read_r1 = os.path.join(READDIR,"%s_non_host_rarefy_even.1.fastq" % samples[i])
