# # # # # # # # # # # # # # # #
# # Bowtie2 - human host genome sequence removal - for Forslund et al T2D Swedish cohort metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/ft2d_swe/2_clean_fastp'

# directory for non-host outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/ft2d_swe/2b_clean_hostremoval'
