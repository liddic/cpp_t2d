...
cd /scratch/pawsey1216/cliddicoat/ft2d_swe/2c_rarefy_even_seq_15th
...
seqtk sample -s100 /scratch/pawsey1216/cliddicoat/ft2d_swe/2b_clean_hostremoval/"$f"_non_host.1.fastq 5018997 > /scratch/pawsey1216/cliddicoat/ft2d_swe/2c_rarefy_even_seq_15th/"$f"_non_host_rarefy_even.1.fastq
