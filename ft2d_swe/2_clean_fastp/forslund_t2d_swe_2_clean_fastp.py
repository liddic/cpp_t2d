# # # # # # # # # # # # # # # #
# # Fastp - QC trimming for Forslund et al T2D Swedish cohort metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/ft2d_swe/1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/ft2d_swe/2_clean_fastp'
...
for i in range(n):
    ...
    fh.writelines("    --trim_front1 5 --trim_tail1 5 --trim_front2 5 --trim_tail2 5 \\\n")
