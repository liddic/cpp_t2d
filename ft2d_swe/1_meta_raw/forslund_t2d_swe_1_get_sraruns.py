# # # # # # # # # # # # # # # #
# # Download SRA fastq files - Forslund T2D Swedish cohort  metagenomics
# # # # # # # # # # # # # # # #
...
file_path = '/scratch/pawsey1216/cliddicoat/ft2d_swe/1_meta_raw/forslund-t2d-swe-run-list.txt'
