# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for AMI disturbed vs natural metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/ami_2025/2_clean_fastp_cat'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/ami_2025/3_fxn_superfocus'
...
#table = pd.read_csv('/scratch/pawsey1216/cliddicoat/ami_2025/1_meta_raw/combined_reads_hazda.tsv.txt', sep='\t')
#
...
with open( "/scratch/pawsey1216/cliddicoat/ami_2025/2_clean_fastp_cat/ami_dist_vs_nat_unique_samps.txt" , "r" ) as f:
