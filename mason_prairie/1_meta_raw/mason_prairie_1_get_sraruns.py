# # # # # # # # # # # # # # # #
# # Download SRA fastq files - Mason et al prairie restoration metagenomics
# # # # # # # # # # # # # # # #
...
file_path = '/scratch/pawsey1216/cliddicoat/mason_prairie/1_meta_raw/SRR_Acc_List_mason_prairie.txt'
