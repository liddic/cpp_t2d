# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Mason et al prairie restoration metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/mason_prairie/2_clean_fastp'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/mason_prairie/3_fxn_superfocus'
...
table = pd.read_csv('/scratch/pawsey1216/cliddicoat/mason_prairie/1_meta_raw/mason_prairie_combined_reads.tsv.txt', sep='\t')
