...
# - collate_compounds
#
# For study - Mason et al prairie restoration soils
...
message("\nworkdir <- '/scratch/pawsey1216/cliddicoat/mason_prairie/cpp_analysis'")
workdir <- "/scratch/pawsey1216/cliddicoat/mason_prairie/cpp_analysis"
message("\nsetwd(workdir)")
setwd(workdir)
message("\ntemp_dir <- '/scratch/pawsey1216/cliddicoat/mason_prairie/cpp_analysis/working'")
temp_dir <- "/scratch/pawsey1216/cliddicoat/mason_prairie/cpp_analysis/working"

message("\nthis_study <- '-mason-prairie-pawsey'")
this_study <- "-mason-prairie-pawsey"
message("\nphy <- readRDS('phy-phyloseq-fxn-mason-prairie-v8c.RDS')")
phy <- readRDS("phy-phyloseq-fxn-mason-prairie-v8c.RDS")
