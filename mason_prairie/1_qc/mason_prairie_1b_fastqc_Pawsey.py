# # # # # # # # # # # # # # # #
# # FastQC (without MultiQC) - for Mason et al prairie restoration metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/mason_prairie/1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/pawsey1216/cliddicoat/mason_prairie/1_qc'
