# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for PRJNA622674_NIBSC_WGS_cultures metagenomics
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/pawsey1216/cliddicoat/PRJNA622674_NIBSC_WGS_cultures/2_clean_fastp'

# set working directory
workDir = '/scratch/pawsey1216/cliddicoat/PRJNA622674_NIBSC_WGS_cultures/3_fxn_superfocus'
...
table = pd.read_csv('/scratch/pawsey1216/cliddicoat/PRJNA622674_NIBSC_WGS_cultures/1_meta_raw/combined_reads_PRJNA622674_NIBSC_WGS_cultures.tsv.txt', sep='\t')
